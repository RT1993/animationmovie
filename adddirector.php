...
{
  $movie_id = $_POST['movie_id'];
  $sql =  "UPDATE director SET director='$director', gender='$gender', date='$date', country='$country'
  WHERE id = $movie_id";
} else {

   $sql = "INSERT INTO director(director, gender, date, country, Movie_id) 
   VALUES ('$director','$gender','$date','$country','$Movie_id')";
}
?>
